...
namespace billythekid\rating\fields;

use billythekid\rating\Rating;
use billythekid\rating\assetbundles\field\FieldAsset;
...
class  extends Field
{
    ...
    public function getSettingsHtml()
    {
        ...
        return Craft::$app->getView()->renderTemplate(
            'rating/_components/fields/_settings',
            [
                'field' => $this,
            ]
        );
    ...
    public function getInputHtml($value, ElementInterface $element = null): string
    {
        ...
        Craft::$app->getView()->registerJs("$('#{$namespacedId}-field').Rating(" . $jsonVars . ");");

        // Render the input template
        return Craft::$app->getView()->renderTemplate(
            'rating/_components/fields/_input',
            [
                'name' => $this->handle,
                'value' => $value,
                'field' => $this,
