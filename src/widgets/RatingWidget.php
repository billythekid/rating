...
namespace billythekid\rating\widgets;

use billythekid\rating\Rating;
use billythekid\rating\assetbundles\ratingwidgetwidget\RatingWidgetWidgetAsset;
...
class RatingWidget extends Widget
{
    ...
    {
        return Craft::t('rating', 'RatingWidget');
    }
    ...
    {
        return Craft::getAlias("@billythekid/rating/assetbundles/ratingwidgetwidget/dist/img/RatingWidget-icon.svg");
    }
    ...
    public function getSettingsHtml()
    {
        return Craft::$app->getView()->renderTemplate(
            'rating/_components/widgets/RatingWidget_settings',
            [
                'widget' => $this
            ]
        );
    ...
    {
        Craft::$app->getView()->registerAssetBundle(RatingWidgetWidgetAsset::class);

        return Craft::$app->getView()->renderTemplate(
            'rating/_components/widgets/RatingWidget_body',
            [
